...
const Step2PersonA: React.FC<Step2PersonAProps> = React.memo(({
  register,
  setValue,
  watch,
  errors,
        ...
        <div className="flex items-center justify-center px-6 py-2">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 tracking-tight">
              Your <em className="italic font-light">Details</em>
            </h1>
...
Step2PersonA.displayName = 'Step2PersonA';

export default Step2PersonA;
