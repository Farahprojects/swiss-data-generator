...
export const NotificationsPanel = () => {
  ...
  const isNotificationEnabled = (type: string): boolean => {
    if (!localPrefs) return true;
    return localPrefs[type as keyof typeof localPrefs] === true;
  };
      ...
      <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  disabled={loading || !localPrefs?.email_notifications_enabled}
                  className="focus:ring-2 focus:ring-primary"
                />
              </div>
        ...
        {localPrefs && !localPrefs.email_notifications_enabled && (
          <div className="bg-gray-50 p-4 rounded-md text-gray-500 text-sm">
            Email notifications are currently disabled. Enable the master switch
            to manage individual notification settings.
          </div>
        )}
