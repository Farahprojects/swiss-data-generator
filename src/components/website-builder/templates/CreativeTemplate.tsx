    ...
    <div className={`bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 ${isPreview ? 'min-h-0' : 'min-h-screen'}`} style={{ fontFamily: `${fontFamily}, sans-serif` }}>
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
                <h1 className="text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 bg-clip-text text-transparent leading-tight">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Button 
                    variant="outline" 
                    className="px-8 py-4 text-lg rounded-full border-2 hover:bg-white hover:shadow-lg transition-all"
                  >
                    Explore Methods
                  </Button>
                </div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="h-32 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl transform rotate-3"></div>
                  <div className="h-48 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl transform -rotate-2"></div>
                </div>
                <div className="space-y-4 mt-8">
                  <div className="h-40 bg-gradient-to-br from-blue-400 to-teal-500 rounded-2xl transform rotate-1"></div>
                  <div className="h-36 bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl transform -rotate-3"></div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 relative">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-32 h-32 bg-yellow-300 rounded-full opacity-30 animate-float"></div>
          <div className="absolute bottom-10 right-10 w-24 h-24 bg-pink-300 rounded-full opacity-40 animate-float" style={{ animationDelay: '1s' }}></div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-orange-500 to-purple-500 bg-clip-text text-transparent">
            Creative Services
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(customizationData.services || []).map((service: any, index: number) => (
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl transform transition-all hover:shadow-2xl"
              >
                <div 
                  className="w-16 h-16 rounded-2xl mb-6 bg-gradient-to-br from-current to-purple-500"
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center text-white">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">Let's turn your dreams into colorful reality.</p>
            <Button className="bg-white text-purple-600 hover:bg-gray-100 px-10 py-4 text-lg rounded-full shadow-xl transform hover:scale-105 transition-all">
