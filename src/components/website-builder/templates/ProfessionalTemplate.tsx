    ...
    <div className={`bg-white ${isPreview ? 'min-h-0' : 'min-h-screen'}`} style={{ fontFamily: `${fontFamily}, sans-serif` }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button variant="outline" className="px-8 py-4 text-lg border-gray-300">
                  Download Brochure
                </Button>
              </div>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg p-8 text-white shadow-2xl">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2">
              <h2 className="text-4xl font-bold mb-6 text-gray-900">Professional Excellence</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full mt-1" style={{ backgroundColor: themeColor }}></div>
                  <div>
            ...
            <div>
              <div className="bg-gray-100 rounded-lg h-64 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  <div className="w-20 h-20 mx-auto mb-4 rounded-full" style={{ backgroundColor: themeColor }}></div>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Executive Services</h2>
            <p className="text-xl text-gray-600">Tailored solutions for leadership excellence</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(customizationData.services || []).map((service: any, index: number) => (
              <motion.div
                ...
                className="bg-white rounded-lg p-8 shadow-sm hover:shadow-lg transition-shadow border"
              >
                <div className="w-12 h-12 rounded-lg mb-6 flex items-center justify-center" style={{ backgroundColor: `${themeColor}15` }}>
                  <div className="w-6 h-6 rounded" style={{ backgroundColor: themeColor }}></div>
                </div>
      ...
      <section className="py-20" style={{ backgroundColor: themeColor }}>
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          <h2 className="text-4xl font-bold mb-6">Ready to Elevate Your Leadership?</h2>
          <p className="text-xl mb-8 opacity-90">Let's discuss how we can accelerate your professional growth.</p>
