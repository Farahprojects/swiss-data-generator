      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
          <div className="col-span-1 lg:col-span-1">
            <p className="text-sm mb-4 max-w-md text-left">
              Advanced astrological insights and personalized reports powered by precise calculations and AI analysis.
              Trusted by astrologers and enthusiasts worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/report" className="hover:text-primary transition-colors">Public Reports</Link></li>
