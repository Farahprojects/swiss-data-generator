...
const MobileLanding: React.FC<Props> = ({ onGoogle, onApple }) => {
  ...
  // Rotating words for the "Your..." animation - same as main index
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Hero Section - Same as main index */}
      ...
      {/* Auth Section (black) */}
      <section className="bg-black text-white px-5 pt-8 pb-10 rounded-t-3xl">
