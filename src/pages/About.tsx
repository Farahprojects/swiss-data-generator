          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row gap-12 max-w-4xl mx-auto justify-center">
              ...
              <div className="backdrop-blur-sm bg-white/50 rounded-2xl p-10 shadow-lg border border-white/20 hover:shadow-xl transition-all flex flex-col justify-between flex-1 max-w-md">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 mb-6 rounded-full overflow-hidden flex items-center justify-center">
                    <img src={normalizeStorageUrl("https://auth.therai.co/storage/v1/object/public/therai-assets/me.png")} alt="Peter Farah" className="object-cover w-24 h-24" loading="lazy" />
                  </div>
              ...
              <div className="backdrop-blur-sm bg-white/50 rounded-2xl p-10 shadow-lg border border-white/20 hover:shadow-xl transition-all flex flex-col justify-between flex-1 max-w-md">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 mb-6 rounded-full overflow-hidden flex items-center justify-center">
                    <img src={normalizeStorageUrl("https://auth.therai.co/storage/v1/object/public/therai-assets/OpenAI-black-monoblossom.png")} alt="OpenAI Logo" className="object-contain w-20 h-20" loading="lazy" />
                  </div>
