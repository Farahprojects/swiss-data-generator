          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
              ...
              <div className="backdrop-blur-sm bg-white/50 rounded-2xl p-10 shadow-lg border border-white/20 hover:shadow-xl transition-all flex flex-col justify-between">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 mb-6 rounded-full overflow-hidden flex items-center justify-center">
                    <img src="https://wrvqqvqvwqmfdqvqmaar.supabase.co/storage/v1/object/public/therai-assets//me.png" alt="Peter Farah" className="object-cover w-24 h-24" />
                  </div>
              ...
              <div className="backdrop-blur-sm bg-white/50 rounded-2xl p-10 shadow-lg border border-white/20 hover:shadow-xl transition-all flex flex-col justify-between">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 mb-6 rounded-full overflow-hidden flex items-center justify-center">
                    <img src="https://wrvqqvqvwqmfdqvqmaar.supabase.co/storage/v1/object/public/therai-assets//OpenAI-black-monoblossom.png" alt="OpenAI Logo" className="object-contain w-20 h-20" />
                  </div>
