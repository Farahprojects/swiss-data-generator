...
const ClientDetailPage = () => {
  ...
  const [unifiedModalMode, setUnifiedModalMode] = useState<'insight' | 'report'>('insight');
  ...
  return (
    <TooltipProvider>
      <div className="min-h-screen">
        ...
        {/* Unified Generate Modal for both insights and reports */}
        {client && (
