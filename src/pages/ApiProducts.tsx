  ...
  const apiModules = [
    {
      ...
      description: "Calculate detailed natal charts with both Western and Vedic systems. Includes planet positions, house cusps, aspects, and essential dignities.",
      features: ["Western & Vedic systems", "Planet positions & aspects", "House systems", "Essential dignities"],
      icon: "✨",
    },
    {
