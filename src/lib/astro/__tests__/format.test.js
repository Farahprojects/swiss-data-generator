// Quick tests for astro position formatting utilities (compiled JS version)

// Simple implementation for testing
function formatDegMin(dec) {
...
console.log('null →', formatDegMin(null)); // Should be "—"
