...
async function logToSupabase(
  ...
  if (responsePayload && typeof responsePayload === 'object' && responsePayload.swiss_data) {
    console.log('[logToSupabase] Processing swiss_data:', !!responsePayload.swiss_data);
    console.log('[logToSupabase] Processing request_payload:', !!requestPayload);
    ...
    try {
      ...
      hasNamedData = true;
      console.log('[logToSupabase] Name injection completed');
      
    } catch (err) {
      console.error('[logToSupabase] Name injection failed:', err.message);
      swissDataNamed = { error: 'Name injection failed', details: err.message };
      hasNamedData = false;
