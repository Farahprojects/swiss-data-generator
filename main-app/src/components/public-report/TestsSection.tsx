...
const getTestDataWithPricing = (getPriceById: any): Test[] => [
  {
    ...
    time: "5 min",
    color: "bg-blue-500",
    imageSrc: normalizeStorageUrl("https://api.therai.co/storage/v1/object/public/feature-images/waterfall.png")
  },
  {
    id: "Compatibility",
    name: "Compatibility",
    ...
    time: "10 min",
    color: "bg-pink-500",
    imageSrc: normalizeStorageUrl("https://api.therai.co/storage/v1/object/public/feature-images/hand.png")
  },
  {
    id: "AstroData",
    name: "Focus",
    ...
    time: "10 min",
    color: "bg-gray-900",
    imageSrc: normalizeStorageUrl("https://api.therai.co/storage/v1/object/public/feature-images/focus.png")
  },
  {
    id: "SnapShot",
    name: "Timing",
    ...
    time: "12 min",
    color: "bg-orange-500",
    imageSrc: normalizeStorageUrl("https://api.therai.co/storage/v1/object/public/feature-images/month.png")
  },
];
